    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                >Catat goal dalam pertandingan</p>
            </div>
            ...
            <div class="col-lg-8">
                ...
                >
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h5
                                    ...
                                    style="color: var(--text-primary); font-weight: 600;"
                                >Informasi Goal</h5>
                                <small class="text-white">Lengkapi detail goal</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <form
                            action="{{ route('match_goals.store') }}"
                            method="POST"
                            id="goalForm"
                        >
                            @csrf
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-12">
                                    ...
                                    >
                                        ...
                                        <option
                                            ...
                                            {{ old('team_id') == $match->team_id_1 ? 'selected' : '' }}
                                        >
                                            {{ $match->teamname_1 }}
                                        </option>
                                        <option
                                            value="{{ $match->team_id_2 }}"
                                            {{ old('team_id') == $match->team_id_2 ? 'selected' : '' }}
                                        >
                                            {{ $match->teamname_2 }}
                                        </option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    >
                                        ...
                                        <option
                                            value="regular"
                                            {{ old('goal_type') == 'regular' ? 'selected' : '' }}
                                        >Regular</option>
                                        <option
                                            value="penalty"
                                            {{ old('goal_type') == 'penalty' ? 'selected' : '' }}
                                        >Penalty</option>
                                        <option
                                            value="own_goal"
                                            {{ old('goal_type') == 'own_goal' ? 'selected' : '' }}
                                        >Own Goal</option>
                                    </select>
                                    @error('goal_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            >
                                ...
                                <button
                                    ...
                                    id="submitBtn"
                                >
                                    <i class="fas fa-save me-2"></i>Simpan Goal
                                </button>
                            </div>
                        </form>
                    </div>
