...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                >Buat kompetisi olahraga baru</p>
            </div>
                    ...
                    >
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <small class="text-white">Lengkapi detail kompetisi</small>
                            </div>
                        </div>
                    </div>
                        ...
                        >
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    >
                                        ...
                                        @for ($i = date('Y') + 1; $i >= 2020; $i--)
                                            <option
                                                value="{{ $i }}"
                                                {{ old('year') == $i ? 'selected' : ($i == date('Y') ? 'selected' : '') }}
                                            >
                                                {{ $i }}
                                            </option>
                                        @endfor
                                ...
                                <div class="col-md-6">
                                    ...
                                    >
                                        ...
                                        <option
                                            value="internal"
                                            {{ old('category') == 'internal' ? 'selected' : '' }}
                                        >Internal</option>
                                        <option
                                            value="external"
                                            {{ old('category') == 'external' ? 'selected' : '' }}
                                        >External</option>
                                        <option
                                            value="friendly"
                                            {{ old('category') == 'friendly' ? 'selected' : '' }}
                            ...
                            >
                                ...
                                <button
                                    ...
                                    id="submitBtn"
                                >
                                    <i class="fas fa-save me-2"></i>Simpan Kompetisi
                                </button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="card-body p-4 text-center">
                        ...
                        <div id="preview-info">
                            ...
                            <span
                                ...
                                style="font-size: 11px;"
                            >
                                <i class="fas fa-futbol me-1"></i>Event
                            </span>
                            <p
                                id="preview-description"
                                class="small mb-3 text-white"
                            >Deskripsi akan muncul di sini</p>
                            <div class="d-flex justify-content-center mb-2 gap-2">
                                <span
                                    id="preview-start"
                                    ...
                                    style="font-size: 11px;"
                                >
                                    <i class="fas fa-calendar-start me-1"></i>Mulai
                                </span>
                                <span
                                    id="preview-end"
                                    ...
                                    style="font-size: 11px;"
                                >
                                    <i class="fas fa-calendar-check me-1"></i>Selesai
                                </span>
                            </div>
                            <p
                                class="small mb-0 text-white"
                                style="font-style: italic;"
                            >Isi form untuk melihat preview</p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Function to populate event options
            function populateEvents(category, selectedValue = null) {
                console.log('Populating events for category:', category);
                console.log('Available events:', eventsByCategory);
                ...
                if (category && eventsByCategory[category]) {
                    ...
                    eventsByCategory[category].forEach(event => {
                        ...
                        if (selectedValue && event === selectedValue) {
                    ...
                    console.log('No events found or category empty');
                }
            }
            ...
            // Load events if old category value exists (after validation error)
            const oldCategory = '{{ old('category') }}';
            const oldEventType = '{{ old('event_type') }}';

            console.log('Old category:', oldCategory);
            console.log('Old event_type:', oldEventType);

            if (oldCategory) {
                console.log('Loading old category and event type');
                populateEvents(oldCategory, oldEventType);

                // Update preview for category
                const categoryMap = {
                    'internal': 'Internal',
                    'external': 'External',
                    'friendly': 'Friendly Match'
                };
                const category = categoryMap[oldCategory] || 'Kategori';
                previewCategory.innerHTML = `<i class="fas fa-layer-group me-1"></i>${category}`;

                // Update preview for event if exists
                if (oldEventType) {
                    previewEvent.innerHTML = `<i class="fas fa-futbol me-1"></i>${oldEventType}`;
                }
            }
